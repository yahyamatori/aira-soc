...
class AttackLog(Base):
    ...
    attack_type = Column(String(50), nullable=False, index=True)  # brute_force, port_scan, ddos, etc
    src_ip = Column(String(45), nullable=False, index=True)  # IPv6 bisa sampai 45 karakter
...
class AttackerSummary(Base):
    ...
    attack_types = Column(Text, nullable=True)  # JSON: {"brute_force": 10, "port_scan": 5}
...
class SystemStatus(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    timestamp = Column(DateTime, nullable=False, index=True)
    component = Column(String(50), nullable=False)  # elasticsearch, telegram, database
