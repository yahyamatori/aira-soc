...
def print_manual_sql():
    ...
    print("\n" + "-" * 70)
    print("-- 1. Cek apakah kolom hostname sudah ada:")
    print("SHOW COLUMNS FROM attack_logs LIKE 'hostname';")
    print("\n-- 2. Jika kolom hostname belum ada, tambahkan dulu:")
    print("ALTER TABLE attack_logs ADD COLUMN hostname VARCHAR(255) NULL;")
    print("\n-- 3. Cek apakah index sudah ada:")
